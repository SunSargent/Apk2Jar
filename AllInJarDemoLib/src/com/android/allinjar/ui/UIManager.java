package com.android.allinjar.ui;

import com.android.allinjar.AllInJar;
import com.android.allinjar.R2;
...
public class UIManager {
	...
	public Dialog showMain(final Context context) {
		View view = AllInJar.getView(context, R2.layout.allinjar_activity_main);
		final TextView textView00 = (TextView) view.findViewWithTag("textview_00");
		textView00.setBackground(new BitmapDrawable(context.getResources(), AllInJar.getBitmap(context, R2.drawable.button_bg_normal)));
		textView00.setOnTouchListener(new OnTouchListener() {
			@Override
			public boolean onTouch(View v, MotionEvent event) {
				switch (event.getAction()) {
					case MotionEvent.ACTION_DOWN:
						textView00.setBackground(new BitmapDrawable(context.getResources(), AllInJar.getBitmap(context, R2.drawable.button_bg_pressed)));
						break;
